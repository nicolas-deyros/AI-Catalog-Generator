  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-2 mb-2">
        ...
        <label htmlFor="style-prompt" className="text-lg font-medium text-gray-800">
          Describe Your Catalog's Style
        </label>
      </div>
      <p className="text-sm text-gray-500 mb-4">
        Tell the AI how you want your catalog to look and feel. The more detail, the better!
      </p>
      <textarea
        id="style-prompt"
        value={prompt}
      ...
      />
      <div className="mt-4">
        <h4 className="font-semibold text-gray-600">Need inspiration? Try one of these:</h4>
